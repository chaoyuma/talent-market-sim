...
export const defaultForm = {
  ...
  student_config: {
    ...
    carryover_skill_gain: 0.01,
    further_study_base_rate: 0.08,
    public_exam_base_rate: 0.06,
    flexible_employment_base_rate: 0.05,
    search_persistence_base: 0.75,
    failed_search_exit_boost: 0.08,
  },
  school_config: {
  ...
  employer_config: {
    ...
    threshold_tighten_speed: 0.02,
    tolerance_decrease_speed: 0.02,
  },
  scenario_config: {
    macro_economy: 1.0,
    policy_support: 0.5,
    ...
    migration_cost_weight: 0.15,
    matching_rounds_per_step: 1,
