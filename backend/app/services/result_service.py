...
def build_result_payload(
    ...
    summary = {
        ...
        "final_same_region_employment_rate": final_result.get("same_region_employment_rate", 0.0),
        "final_carryover_student_count": final_result.get("carryover_student_count", 0),
        "final_new_cohort_student_count": final_result.get("new_cohort_student_count", 0),
        "final_new_cohort_employment_rate": final_result.get("new_cohort_employment_rate", 0.0),
        "final_carryover_employment_rate": final_result.get("carryover_employment_rate", 0.0),
        "final_carryover_pool_share": final_result.get("carryover_pool_share", 0.0),
        "final_avg_carryover_rounds": final_result.get("avg_carryover_rounds", 0.0),
        ...
        "final_round_application_count": final_result.get("round_application_count", 0),
        "final_round_offer_count": final_result.get("round_offer_count", 0),
        "final_round_accepted_offer_count": final_result.get("round_accepted_offer_count", 0),
        "final_round_rejected_offer_count": final_result.get("round_rejected_offer_count", 0),
        "final_avg_applications_per_job": final_result.get("avg_applications_per_job", 0.0),
        "final_avg_offers_per_student": final_result.get("avg_offers_per_student", 0.0),
